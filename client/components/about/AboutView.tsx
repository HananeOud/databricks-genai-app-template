  ...
  if (!content) {
    return (
      <div className="relative w-full h-full bg-[var(--color-background-1)] dark:bg-[var(--color-background-1)] flex items-center justify-center">
        ...
        />
        <div className="relative text-[var(--color-text-muted)]">Loading...</div>
      </div>
    )
  }
    ...
    <div className="relative w-full h-full overflow-hidden bg-[var(--color-background-1)] dark:bg-[var(--color-background-1)]">
      ...
      <div className="relative h-full overflow-y-auto scroll-smooth about-scroll-container">
        ...
        <div className="relative z-10">
          <div className="max-w-7xl mx-auto px-6 md:px-8 py-16 md:py-24 bg-[var(--color-background-1)]/95 backdrop-blur-xl rounded-t-3xl shadow-2xl"
            style={{
          ...
          <div className="space-y-32">
            {content.sections.map((section, index) => {
              ...
              return (
                ...
                >
                  {/* Text Content */}
                  <div className={`${isEven ? '' : 'md:col-start-2'} space-y-6`}>
                    ...
                    <ul className="space-y-3 mt-6">
                      {section.highlights.map((highlight, idx) => (
                        <li
                          ...
                          style={{
                            animation: isVisible ? `slide-in 0.5s ease-out ${idx * 0.1}s both` : 'none'
                          }}
                        >
